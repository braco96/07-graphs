package com.braco96.algoritmosestructuras.graphs._01_route_between_nodes;

import com.braco96.algoritmosestructuras.graphs._00_graph_search.Graph;
import com.braco96.algoritmosestructuras.graphs._00_graph_search.GraphNode;
import com.braco96.algoritmosestructuras.graphs._00_graph_search.GraphNodeStatus;
...
public class RouteBetweenNodesSolution {
  ...
  public static void main(String[] args) {
      boolean [][] a= {{true, true, true}, {true, false, true}};

        Arrays.stream(a).map(x -> Arrays.toString(x).forEach(System.out::println)==true;
  }
}
